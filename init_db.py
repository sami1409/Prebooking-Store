...
cur.execute("INSERT INTO Admin (username, password,a_id) VALUES ('nooshin','b200690cs',3)")
cur.execute("INSERT INTO Admin (username, password,a_id) VALUES ('sami','b200752cs',4)")
